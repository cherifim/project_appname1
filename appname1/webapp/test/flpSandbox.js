		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Title",
									"targetURL": "#mynamespaceappname1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mynamespaceappname1-display": {
								"semanticObject": "mynamespaceappname1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mynamespace.appname1",
									"url": sap.ui.require.toUrl("mynamespace/appname1")
								}
							}
						}
					}
